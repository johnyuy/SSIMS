...

    {
        ...
        static void InitItems(DatabaseContext context)
        {
            ...
            List<Item> items = new List<Item>
            {
                ...
                new Item("H011","Pen","Highlighter Blue","Box","~/Resources/Items/highlighters.png"),
                new Item("H012","Pen","Highlighter Green","Box","~/Resources/Items/highlighters.png"),
                new Item("H013","Pen","Highlighter Pink","Box","~/Resources/Items/highlighters.png"),
                new Item("H014","Pen","Highlighter Yellow","Box","~/Resources/Items/highlighters.png"),
        ...
        static void InitDocuments(DatabaseContext context)
        {
            ...
            disbursementList4.RepliedByStaff = StaffRepository.GetByID(10014);
            ...
            disbursementList5.RepliedByStaff = StaffRepository.GetByID(10014);
            ...
            disbursementList5.ItemTransactions = disbursedItems5;
            ...
            disbursementList6.RepliedByStaff = StaffRepository.GetByID(10014);
            ...
            context.DisbursementLists.Add(disbursementList6);
